 ...
 * 
 * We all make mistakes. After the book was published, one keen-eye
 ...
 * theoretically the card_name[0] might have *any* char
 ...
 * terrible vengeance will be wrought against them.
 */
